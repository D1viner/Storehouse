...
<style>
.bg-body {
	background-color: #f8f9fa; /* 背景颜色和 body 相同 */
}
					...
					<div class="col-md-2 my-2">
						<div class="form-floating mb-3">
							<input type="text" class="form-control datepicker" id="dateInput"
								placeholder="Select date" name="inventorydatefrom" value=<%=inventorydatefrom %>> <label for="dateInput">From</label>
						</div>
					</div>
					<div class="col-md-2 my-2">
						<div class="form-floating mb-3">
							<input type="text" class="form-control datepicker" id="dateInput"
								placeholder="Select date" name="inventorydateto" value=<%=inventorydateto %>> <label for="dateInput">to</label>
						</div>
					</div>
					...
					<tbody class="table-group-divider">
						<%
							for (Map map : list) {
								...
								out.print("<td>" + "<a class='btn btn-sm btn-outline-dark' style='border-radius: 15px;' href=storehouse_show.jsp?no="
												+ map.get("no") + ">编辑</a>&nbsp;&nbsp;"
