	...
	<header class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<div class="ms-auto">
					<a class="btn btn-warning" href="storehouse_list">Back</a>
				</div>
			</div>
		</div>
	</header>
						...
						<form action="update">
							...
							<div class="form-floating mb-3 rounded-input">
								<input type="text" class="form-control rounded-input"
									...
									value="${storehouse.name}"> <label for="floatingInput">Name</label>
							</div>
							<div class="form-floating mb-3 rounded-input">
								<input type="text" class="form-control rounded-input"
									id="floatingInput" name="price" placeholder="Price"
									value="${storehouse.price}"> <label for="floatingInput">Price</label>
							</div>
							<div class="form-floating mb-3 rounded-input">
								<input type="text" class="form-control rounded-input"
									id="floatingInput" name="num" placeholder="Number"
									value="${storehouse.num}"> <label for="floatingInput">Number</label>
							</div>
							<div class="form-floating mb-3 rounded-input">
								<input type="text" class="form-control rounded-input"
									id="floatingInput" name="storehouseid"
									placeholder="Storehouseid" value="${storehouse.storehouseid}">
							...
							<div class="form-floating mb-3 rounded-input">
								<div class="form-floating mb-3">
									<input type="text" class="form-control datepicker"
										...
										name="inventorydate" value="${storehouse.inventorydate}"> <label
										for="dateInput">Inventorydate</label>
								</div>
							</div>
							<br>
