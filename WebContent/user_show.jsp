<%@ page language="java" pageEncoding="UTF-8" import="javabean.User"%>
<%
	...
	<header class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<div class="ms-auto">
					<a class="btn btn-warning" href="user_list.jsp">Back</a>
				</div>
			</div>
		</div>
	</header>
						...
						<form action="userupdate">
							<div class="form-floating mb-3 rounded-input">
								<input type="text" class="form-control rounded-input"
									...
									value=<%=ur.getUsername()%>> <label for="floatingInput">Username</label>
							</div>
							<div class="form-floating mb-3 rounded-input">
								<input type="text" class="form-control rounded-input "
									id="floatingPassword" placeholder="Password" name="password"
									value=<%=ur.getPassword()%>> <label
