						...
						<form action="stupdate">
							...
							<div class="form-floating mb-3 rounded-input">
								<input type="text" class="form-control rounded-input" id="floatingInput"
									name="id" placeholder="Id" readonly value=<%=st.getId() %>> <label
									for="floatingInput">Id</label>
							</div>
							
							<div class="form-floating mb-3 rounded-input">
								<input type="text" class="form-control rounded-input" id="floatingInput"
									name="name" placeholder="Name" value=<%=st.getName() %>> <label
									for="floatingInput">Name</label>
							</div>
							<div class="form-floating mb-3 rounded-input">
								<input type="text" class="form-control rounded-input" id="floatingInput"
									name="address" placeholder="Address" value=<%=st.getAddress() %>> <label
